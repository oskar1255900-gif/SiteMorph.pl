      ...
      <motion.div initial={{ y: 24, scale: 0.96 }} animate={{ y: 0, scale: 1 }} exit={{ y: 16, scale: 0.97, opacity: 0 }} transition={springTransition} className="relative w-full max-w-[460px] rounded-2xl border bg-white dark:bg-neutral-950 border-[#EAEAEA] dark:border-neutral-800 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] overflow-hidden text-[#2563eb] dark:text-white">
        ...
        <div className="px-8 pb-8 space-y-5">
          <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={handleGoogle} disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800 font-semibold text-[15px] text-[#2563eb] dark:text-white hover:bg-neutral-50 dark:hover:bg-neutral-800 disabled:opacity-50 shadow-sm transition-colors">
          ...
          <form onSubmit={handleEmail} className="space-y-3.5">
            ...
            <motion.button whileTap={{ scale: 0.99 }} type="submit" disabled={loading}
              className="w-full py-4 rounded-2xl bg-[#2563eb] text-white font-semibold text-[15px] disabled:opacity-50 shadow-lg shadow-blue-500/25 hover:bg-blue-700 transition-colors">
