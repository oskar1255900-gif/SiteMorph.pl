...
export const ACADEMY_GUIDES: Array<{ title: string; category: string; level: string; time: string; excerpt: string; content: Array<{ h: string; p: string }> }> = [
  ...
  },
  {
    ...
    content: [
      { h: 'Krok 1: Napisz prompt', p: 'W Pulpicie wpisz jedno zdanie: „Stwórz stronę dla barbera Złoty Grzebień w Warszawie, ciemny motyw, sekcje: usługi, cennik, rezerwacja, opinie, Instagram". Unikaj ogółników typu „ładna strona" — AI potrzebuje branży, miasta i stylu.' },
      ...
      { h: 'Krok 3: Podgląd i akceptacja', p: 'Skopiuj link podglądu i wyślij klientowi. Klient otwiera na telefonie — widzi zmiany na żywo bez logowania. Gdy zaakceptuje, kliknij Opublikuj. Strona ląduje na *.sitemorph.pl lub Twojej domenie (Business).' },
  ...
  },
  {
    ...
    content: [
      { h: 'Widełki realne', p: 'Polska 2024/2025: wizytówka AI: 800–1 900 zł, strona firmowa 5–7 podstron: 2 500–4 500 zł, landing + copywriting SEO: 4 000–7 000 zł, white-label dla agencji: 8 000–12 000 zł. Poniżej 800 zł psujesz rynek i marzę.' },
  ...
  },
  {
    ...
    content: [
      { h: 'Opcja A: subdomena SiteMorph', p: 'Najprostsza: twojklient.sitemorph.pl — działa od razu po kliknięciu Opublikuj. Dobre na pokaz i test. Możesz zmienić później na własną domenę bez utraty treści.' },
      { h: 'Opcja B: własna domena (zalecane)', p: 'Kup domenę (np. OVH, Aftermarket) → w Kreatorze → Opublikuj → Własna domena → wpisz np. zlotygrzebien.pl → skopiuj rekordy DNS (CNAME → cname.sitemorph.pl, TXT do weryfikacji) → wklej u rejestratora. Propagacja 5–60 min.' },
